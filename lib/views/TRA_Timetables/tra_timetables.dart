                  ...
                  return <Widget>[
                    SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        centerTitle: true,
                        titlePadding: EdgeInsets.only(bottom: 8.0, left: 16.0, right: 16.0), // Example
                        title: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                           children: [
                            ...
                            Text(
                              localizations.routeDescription(vm.trainInfo?["StartingStationName"]?[locale] ?? "",vm.trainInfo?["EndingStationName"]?[locale] ?? ""),
                              style: TextStyle(
                                color: Theme.of(
                                  context,
                                ).textTheme.titleLarge?.color,
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              ...
                              child: Row(
                                children: [
                                  Text(info["StationName"][locale], style: TextStyle(fontSize: 18)),
                                ],
                              ),
                            ),
                            Expanded(
